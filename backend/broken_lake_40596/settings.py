"""
Django settings for broken_lake_40596 project.
...
ROOT_URLCONF = 'broken_lake_40596.urls'
...
WSGI_APPLICATION = 'broken_lake_40596.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_lake_40596 API",
    "DESCRIPTION": "API documentation for broken_lake_40596 App",
    "VERSION": "v1",
}
